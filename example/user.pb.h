...
template<> ::fixbug::RegisterResquest* Arena::CreateMaybeMessage<::fixbug::RegisterResquest>(Arena*);
...
class RegisterResquest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegisterResquest) */ {
 public:
  RegisterResquest();
  ...
  inline void Swap(RegisterResquest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline RegisterResquest* New() const final {
    return CreateMaybeMessage<RegisterResquest>(nullptr);
  }

  RegisterResquest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RegisterResquest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegisterResquest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegisterResquest)
 private:
  class _Internal;
...
// uint32 id = 1;
inline void RegisterResquest::clear_id() {
  id_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterResquest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterResquest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResquest.id)
  return _internal_id();
}
inline void RegisterResquest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void RegisterResquest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterResquest.id)
}

// bytes pwd = 2;
inline void RegisterResquest::clear_pwd() {
  pwd_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RegisterResquest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResquest.pwd)
  return _internal_pwd();
}
inline void RegisterResquest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterResquest.pwd)
}
inline std::string* RegisterResquest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterResquest.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& RegisterResquest::_internal_pwd() const {
  return pwd_.GetNoArena();
}
inline void RegisterResquest::_internal_set_pwd(const std::string& value) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RegisterResquest::set_pwd(std::string&& value) {
  
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterResquest.pwd)
}
inline void RegisterResquest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterResquest.pwd)
}
inline void RegisterResquest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterResquest.pwd)
}
inline std::string* RegisterResquest::_internal_mutable_pwd() {
  
  return pwd_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RegisterResquest::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterResquest.pwd)
  
  return pwd_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RegisterResquest::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterResquest.pwd)
}
